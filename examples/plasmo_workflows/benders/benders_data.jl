...
# ('S7', 'F2') :  1.18728419327
# ('S2', 'F0') :  1.89729234216
# ('S30', 'F2') :  1.59806232015
# ('S30', 'F8') :  1.23733273293
# ('S3', 'F1') :  0.795904267414
# ('S16', 'F5') :  1.10234446334
# ('S30', 'F6') :  1.14127491017
# ('S24', 'F8') :  0.616112590853
# ('S1', 'F0') :  1.39729234216
# ('S30', 'F1') :  1.72843513522
# ('S6', 'F2') :  0.687284193269
# ('S15', 'F5') :  0.602344463339
# ('S25', 'F8') :  1.11611259085
# ('S10', 'F3') :  1.00419248647
# ('S28', 'F9') :  1.26631900148
# ('S4', 'F1') :  1.29590426741
# ('S0', 'F0') :  0.897292342163
# ('S27', 'F9') :  0.766319001484
# ('S20', 'F6') :  1.58738493928
# ('S18', 'F6') :  0.58738493928
# ('S26', 'F8') :  1.61611259085
# ('S14', 'F4') :  1.50879649731
# ('S30', 'F9') :  1.93568757332
# ('S29', 'F9') :  1.76631900148
# ('S30', 'F0') :  1.64613524026
# ('S13', 'F4') :  1.00879649731
# ('S19', 'F6') :  1.08738493928
# ('S21', 'F7') :  0.505947313864
# ('S30', 'F4') :  1.50649166415
# ('S17', 'F5') :  1.60234446334
# ('S5', 'F1') :  1.79590426741
# ('S12', 'F4') :  0.508796497315
# ('S11', 'F3') :  1.50419248647
# ('S8', 'F2') :  1.68728419327
# ('S23', 'F7') :  1.50594731386
# ('S30', 'F3') :  1.80807534828
# ('S30', 'F7') :  1.12260715956
# ('S9', 'F3') :  0.504192486475
# ('S30', 'F5') :  1.39061804486
# ('S22', 'F7') :  1.00594731386
# "
#
# s2 = replace(s, r"'", "\"")
# s3 = replace(s2, r":", "=")
# s4 = replace(s3,"(","costscens[(")
# s5 = replace(s4,")",")]")
