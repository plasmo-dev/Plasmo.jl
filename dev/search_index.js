...
{
    "location": "documentation/modelgraph/#OptiGraph-1",
    "page": "Modeling",
    "title": "OptiGraph",
    "category": "section",
    "text": ""
...

{
    ...
    "title": "Constructor",
    "category": "section",
    "text": "The OptiGraph is the primary object for creating graph-based models in Plasmo.jl.  A OptiGraph extends the JuMP.AbstractModel and offers a collection of OptiNodes (which also extend JuMP.AbstractModel) which represent solvable optimization problems. OptiNodes are connected by LinkConstraints over variables which induce underlying LinkEdges.  sA OptiGraph does not require any arguments to construct:mg = OptiGraph()A OptiGraph optimizer can be specified in the same way as in JuMP using set_optimizer(::OptiGraph).  An optimizer can be any JuMP compatible solver or a custom Plasmo.jl provided solver (see the solvers section).   For example, we could construct an OptiGraph that uses Ipopt.Opimizer from the Ipopt package:graph = OptiGraph()\nipopt = Ipopt.Optimizer\nset_optimizer(graph,ipopt)"
},

{
    "location": "documentation/modelgraph/#Adding-OptiNodes-1",
    "page": "Modeling",
    "title": "Adding OptiNodes",
    "category": "section",
    "text": "OptiNodes can be added to a OptiGraph using the @optinode macro.  For instance, the below piece of code add the node n1 to the OptiGraph mg@optinode(mg,n1)It is also possible to create sets of OptiNodes in a single call to @optinode like shown in the below code snippet. This example creates a 2x2 grid of OptiNodes.@optinode(mg,nodes[1:2,1:2])\nfor node in nodes\n    @variable(node,x>=0)\nendWe can iterate over the nodes in a OptiGraph using the getnodes function.  For examplefor node in getnodes(mg)\n    println(node)\nendwill print the string for every node in the OptiGraph graph.  Variables within a OptiNode can be accessed directly from their enclosing node.  @variable(n1,x >= 0)\nprintln(n1[:x])    #accesses variable x on jump_model"
},
...
{
    "location": "documentation/modelgraph/#Plasmo.OptiGraph",
    "page": "Modeling",
    "title": "Plasmo.OptiGraph",
    "category": "type",
    "text": "OptiGraph()\n\nThe OptiGraph Type.  Represents a graph containing models (nodes) and the linkconstraints (edges) between them.\n\n\n\n\n\n"
},

{
    "location": "documentation/modelgraph/#OptiGraph-2",
    "page": "Modeling",
    "title": "OptiGraph",
    "category": "section",
    "text": "The OptiGraph contains the following useful methods:Plasmo.OptiGraph"
},

{
    "location": "documentation/modelgraph/#OptiNode-1",
    "page": "Modeling",
    "title": "OptiNode",
    "category": "section",
    "text": "OptiNodes contain methods for managing their contained JuMP models.Plasmo.OptiNode\nPlasmo.@optinode(graph::OptiGraph)"
},
...
{
    "location": "documentation/manipulation/#OptiGraph-Functions-1",
    "page": "Manipulation",
    "title": "OptiGraph Functions",
    "category": "section",
    "text": "An OptiGraph supports graph analysis functions such as graph partitioning or community detection.  The graph analysis functions are particularly useful for creating decompositions of optimization problems and in fact, this is what is done to use Plasmo\'s built-in structure-based solvers."
},
...
{
    "location": "tutorials/tutorials/#DC-OPF-1",
    "page": "Tutorials",
    "title": "DC OPF",
    "category": "section",
    "text": ""
